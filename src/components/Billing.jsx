...
const Billing = () => {
  return (
   <section id="product" className={`${layout.sectionReverse}`}>
     ...
     <div className='asbolute z-[3] -left-1/2 top-0 w-[50%] h-[50%] rounded-full white__gradient' />
     <div className='asbolute z-[0] -left-1/2 bottom-0 w-[50%] h-[50%] rounded-full pink__gradient'/>
     </div>
